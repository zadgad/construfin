...
Route::put('/edit/user/{id}', 'App\Http\Controllers\UsrController@editarPas')->name('editP');
Route::get('/Delet=us/{id}', 'App\Http\Controllers\UsrController@deleteuser')->name('deleteUs');
...
Route::post('/sistemConstrumega/editar_empre/{id}','App\Http\Controllers\contrumega@editarempre')->name('editempre');
