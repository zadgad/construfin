@extends('layouts.appl', ['activePage' => 'user-management', 'titlePage' => __(' Lista de Usuarios ')])
@section('content')
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Lista de Clientes en Sistema</h5>
                            <span>Informacion de los que tienen privilegios de Usuarios</span>
                            <br>
                            <br>
                            <h6> </h6>
                        </div>
        ...
        <div class="col-md-12">
            <div class="card table-card">
                ...
                <div class="card">
                    ...
                    <a href="{{ route('register',$rol[3]->id_rol) }}" class="btn btn-sm btn-primary">{{ __('Añadir Usuario') }}</a>
                    <div class="card-body">
                                 ...
                                 <td class="td-actions text-right">
                                       ...
                                       <form action={{-- "{{ route('user.destroy', $user) }}" --}}  method="post">
                                             ...
                                             <a  href="{{route('editaruser',$id=$user->id_usr)}}"><i class="ik ik-edit f-16 mr-15 text-green"></i></a>
                                                                                        <a href="{{ route('deleteUs',$id=$user->id_usr) }}" ><i class="ik ik-trash-2 f-16 text-red"></i></a>
