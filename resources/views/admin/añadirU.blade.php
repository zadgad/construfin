                    ...
                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                              ...
                              <a href="{{route('inicio',$id=session()->get('nombre')->first())}}"><i class="ik ik-home"></i><span></span></a>
                              @else
                               @if(session()->get('user_rol')->first()==2)
                               <a href=""><i class="ik ik-home"></i><span></span></a>
                               @else
                               @if(session()->get('user_rol')->first()>2)
                               <a href=""><i class="ik ik-home"></i><span></span></a>
                               @endif
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Añadir Us.</li>
                        </ol>
                    </nav>
                </div>
            </div>
