 ...
 <div class="main-content">
    <div class="container-fluid">
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Lista de Empleados en Sistema</h5>
                            <span>Informacion de los Usuarios que tienen privilegios de Empleados</span>
                            <br>
                            <br>
                            <h6> </h6>
                        </div>
        ...
        <div class="card">
            ...
            <a href="{{ route('register',$rol[2]->id_rol) }}" class="btn btn-sm btn-primary">{{ __('Añadir Usuario') }}</a>
            <div class="card-body">
